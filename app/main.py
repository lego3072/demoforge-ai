...
APP_NAME = "DemoForge AI"
APP_SLUG = "demoforgeapi"
DEFAULT_BASE_URL = "https://demoforge-ai.up.railway.app"
...
FOLLOWUP_FROM_EMAIL = os.getenv("FOLLOWUP_FROM_EMAIL", "DemoForge AI <joseph@dataweaveai.com>").strip()
...
STARTER_PRICE_LABEL = os.getenv("STARTER_PRICE_LABEL", "$149/mo").strip()
DFY_PRICE_LABEL = os.getenv("DFY_PRICE_LABEL", "$4k one-time").strip()
...
STARTER_MONTHLY_COST_CAP_USD = float(os.getenv("STARTER_MONTHLY_COST_CAP_USD", "14.9"))
